	...
	return (
		<div className={styles['wrapper-new-pass']}>
			<div className="container">
				<h1 className={clsx(styles['main-title-new-pass'], styles['main-title'])}>Новый пароль</h1>
				...
				<div className={styles['block-bg']}>
					...
					<form onSubmit={handleSubmit(onSubmit)} className={styles['form__container-new-pass']}>
						<InputForm
							type="password"
