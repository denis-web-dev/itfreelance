    ...
    <header className={styles.headerProfile}>
        <div className={styles.headerInner}>
          ...
          <div className={styles.actions}>
            <button className={styles.profileHeaderBtnNotification}>
              <svg
                width="22"
                height="22"
                viewBox="0 0 22 22"
            ...
            <div className={styles.profileHeaderEmail}>
              <a
                className={styles.profileHeaderEmailLink}
                href="mailto:user@example.com"
              >
                <svg
                  className={styles.profileHeaderEmailIcon}
                  width="24"
                  height="20"
                  viewBox="0 0 24 20"
                  fill="#1A1A1A"
            ...
            {user && (
              <div className={styles.userInfo}>
                <div className={styles.profileHeaderUser}>
                  {/* {user.fullName?.[0] || ''} */}
                </div>
              </div>
            )}
